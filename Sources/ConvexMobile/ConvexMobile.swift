...
public class ConvexClient {
  ...
  /// Reconnects all active subscriptions.
  ///
  /// This method can be called manually to force reconnection of all subscriptions,
  /// for example after detecting that the app has returned from background.
  /// The client will also automatically call this when network connectivity changes.
